...
public final class LocationFixTest {
	...
	public void testDecode() {
		...
		assertEquals(51.973148, fix.getLat(), 1E-3);
		assertEquals(5.669751, fix.getLon(), 1E-3);
		assertEquals(29.8, fix.getAlt(), 1E-1);
		assertEquals(8, fix.getSats());
	}
	...
	public void testNegativeAltitude() {
		...
		assertEquals(-0.9, fix.getAlt(), 0.1);
	}
