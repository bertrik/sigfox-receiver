...
public final class LocationFixTest {
	...
	public void testDecode() {
		...
		Assert.assertEquals(51.973148, fix.lat, 1E-3);
		Assert.assertEquals(5.669751, fix.lon, 1E-3);
		Assert.assertEquals(29.8, fix.alt, 1E-1);
		Assert.assertEquals(8, fix.sats);
	}
	...
	public void testNegativeAltitude() {
		...
		Assert.assertEquals(-0.9, fix.alt, 0.1);
	}
